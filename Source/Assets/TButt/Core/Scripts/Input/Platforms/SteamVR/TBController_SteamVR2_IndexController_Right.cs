...
{
    public class TBController_SteamVR2_IndexController_Right : TBControllerBase<SteamVRHardwareButton>
    {
        protected static TBController_SteamVR2_IndexController_Right _instance;

        public static TBController_SteamVR2_IndexController_Right instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new TBController_SteamVR2_IndexController_Right();
                    _instance.model = VRController.ValveIndexController;
                    _instance.name = "Index Controller (Right)";
                    _instance.fileName = "Maps_SteamVR_IndexControllerRight";
