...
{
    public class TBController_SteamVR2_WMR_Right : TBControllerBase<SteamVRHardwareButton>
    {
        protected static TBController_SteamVR2_WMR_Right _instance;

        public static TBController_SteamVR2_WMR_Right instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new TBController_SteamVR2_WMR_Right();
