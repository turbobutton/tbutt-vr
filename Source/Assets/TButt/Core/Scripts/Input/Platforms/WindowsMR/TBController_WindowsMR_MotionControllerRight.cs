...
{
    public class TBController_WindowsMR_MotionControllerRight : TBControllerBase<TBWindowsMRInput.Button>
    {
        protected static TBController_WindowsMR_MotionControllerRight _instance;

        public static TBController_WindowsMR_MotionControllerRight instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new TBController_WindowsMR_MotionControllerRight();
                    _instance.model = VRController.WMRController;
                    _instance.name = "Windows Mixed Reality Motion Controller (Right)";
                    _instance.fileName = "Maps_WindowsMR_MotionControllerRight";
